...
import { FaDownload, FaEnvelope, FaLocationPin, FaUser } from 'react-icons/fa6';
                    ...
                    <section className='useradmin_content_section w-[100%]  p-5 text-[30px] overflow-y-scroll'>
                        <section className=' w-[100%] px-3'>
                            ...
                            <div className='font-[500] text-[15px]'>
                                <p className='text-[#1385ff]'>Here you can see your appointment letter</p>
                            </div>
                        </section>
                        ...
                        <section className='mt-[30px] flex justify-evenly flex-wrap py-2 ' ref={contentRef}>
                            <section className=' w-[99%] rounded-[10px] bg-[white]  pt-2 mt-[10px]'>
                                ...
                                <section className='text-center'>
                                    ...
                                    <p className='font-[500] text-[16px] mt-1'>rcmicci@gmail.com</p>
                                    <p className='font-[500] text-[16px] mt-1 px-1'>316, Park View Plaza, 32 Park Area, Ajmal Khan Road Karol Bagh, New Delhi-110005</p>
                                </section>
                                <section className='w-[100%] overflow-hidden text-[24px] py-1 text-white m-auto mt-5 font-[600] flex items-center justify-center bg-[#1385ff] text-center'>
                                    <p> Appointment Letter</p>
                                </section>

                                <section className='px-2 mt-[20px] font-[500]'>
                                    <p className='text-[15px] mt-2 font-[600]'>To,</p>
                                    <p className='text-[15px] mt-[5px]'>{user[0] === undefined ? "No Data Found" : user[0].Full_Name}</p>
                                    <p className='text-[14px] mt-[5px]'>Address: {user[0] === undefined ? "No Data Found" : user[0].Address} </p>
                                    <p className='text-[14px] mt-[5px] font-[600]'>Date: <span className='font-[500]'> <DateFormat value={Date.now()} /></span> </p>
                                    <p className='text-[14px] mt-[30px] font-[600]'>Dear Mr.: <span className='font-[500]'> {user[0] === undefined ? "No Data Found" : user[0].Full_Name}</span> </p>
                                    ...
                                    <p className='text-[14px] mt-[5px]'>Rajkumar Maurya Maurya</p>
                                    <p className='text-[14px] mt-[5px]'>(President / Founder)</p>
                                    <p className='text-[14px] mt-[5px]'>RCMICCI</p>
                                </section>
