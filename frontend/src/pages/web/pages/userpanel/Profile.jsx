                                        ...
                                        <section className='w-[100%] h-[270px] border-[2px] border-[black]  mb-4 bg-[white] rounded-[20px] relative'>
                                            ...
                                            <section className='w-[100%] h-[50%]  rounded-t-[20px] profile_banner relative'>
                                                <section className='w-[100px] h-[100px] rounded-[50%] absolute bottom-[-34%] ms-5 bg-[black] border-[3px] border-[white] overflow-hidden'>
                                                    <img src={user[0] === undefined ? Profilepicture : user[2] + user[0].Profile_Picture} alt="" className='h-[100%] w-[100%] rounded-[50%]' />
                                                </section>
                                            </section>
                                            <section className='w-[100%] h-[50%]  '>
                                                ...
                                                <p className='mt-[2px] ms-3 font-[700] text-[14px] uppercase'>
                                                    {user[0] === undefined ? "No Data Found" : user[0].Full_Name}
                                                </p>
                                                <p className='mt-[2px] ms-3 font-[600] text-[grey] text-[14px] uppercase'>
                                                    {user[0] === undefined ? "No Data Found" : user[0].Occupation}
                                                </p>
                                            </section>
                                        </section>
                                        ...
                                        <section className='w-[100%] border-[2px] border-[black] relative rounded-[20px] bg-[white] mb-4 p-3 py-5'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B] '>
                                                            {user[0] === undefined ? "No Data Found" : user[0].Select_Designation}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                            ...
                                            <section className='w-[100%] flex items-start mt-3 ms-2'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B]'>
                                                            {user[0] === undefined ? "No Data Found" : user[0].Father_Name}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                            ...
                                            <section className='w-[100%] flex items-start mt-3 ms-2'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B] '>
                                                            {user[0] === undefined ? "No Data Found" : user[0].Date_Of_Birth}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                            ...
                                            <section className='w-[100%] flex items-start mt-3 ms-2'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B] '>
                                                            {user[0] === undefined ? "No Data Found" : user[0].Address + "," + " " + user[0].City}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                        ...
                                        <section className='w-[100%] border-[2px] border-[black]  rounded-[20px] bg-[white] mb-4 p-3 py-5 relative'>
                                            ...
                                            <section className='w-[100%] flex items-start mt-3 ms-2'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B]'>
                                                            {user[1] === undefined ? "No Data Found" : user[1].Email}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                            ...
                                            <section className='w-[100%] flex items-start mt-3 ms-2'>
                                                ...
                                                <section className='flex items-start flex-col'>
                                                    ...
                                                    <section>
                                                        <p className='font-[700] uppercase text-[13px] text-[#7B7B7B] '>
                                                            {user[1] === undefined ? "No Data Found" : user[1].Phone}
                                                        </p>
                                                    </section>
                                                </section>
                                            </section>
                                        ...
                                        <form className=' w-[100%] m-auto' onSubmit={formik.handleSubmit}>
                                            <section className='w-[100%] h-[335px] border-[2px] border-[black]  rounded-[20px] bg-[WHITE] relative mb-4  flex justify-between overflow-hidden'>
                                                ...
                                                <section className='profile_banner w-[100%] h-[100px] absolute bg-black'>
                                                    <section className='w-[100px] h-[100px]  border-[4px] border-[white] rounded-[50%] absolute left-[25px] bottom-[-45%] bg-[white] z-50'>
                                                        <section className='w-[100%] h-[100%] rounded-[50%] absolute bg-[white] z-50 overflow-hidden'>
                                                            <img src={image === null ? user[2] + user[0].Profile_Picture : image} alt="" className='w-[100%] h-[100%]' />
                                                        </section>
                                                        <section className='w-[30px] h-[30px] bg-[white] border-[1px] border-[black] absolute top-[70%] rounded-[50%] right-[5px] z-[9999] flex items-center justify-center cursor-pointer'>
                                                            ...
                                                            <section className=' absolute opacity-0 cursor-pointer'>
                                                                <input type="file" className='w-[100%] h-[100%] rounded-[50%]' onChange={(e) => formik.setFieldValue('Profile_Picture', e.target.files[0]) && handleImageChange(e)} />
                                                            </section>
                                                        </section>
                                                    </section>
                                                </section>
                                                <section className='w-[100%] h-[235px] absolute bottom-0'>
                                                    ...
                                                    <div className='mt-[10px] mx-3 font-[700] uppercase'>
                                                        ...
                                                        <input type="text" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Full_Name} onChange={(e) => formik.setFieldValue('Full_Name', e.target.value)} />
                                                    </div>


                                                    <div className='mt-[10px] mx-3 font-[700] uppercase'>
                                                        <label className='w-[100%]'>OCCUPATION</label>
                                                        <input type="text" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Occupation} onChange={(e) => formik.setFieldValue('Occupation', e.target.value)} />
                                                    </div>
                                            ...
                                            <section className='w-[100%] border-[2px] border-[black] relative rounded-[20px] bg-[white] mb-4 p-3 py-5'>
                                                ...
                                                <div className='mt-[10px] font-[700] uppercase'>
                                                    ...
                                                    <select className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Select_Designation} onChange={(e) => formik.setFieldValue('Select_Designation', e.target.value)} >
                                                ...
                                                <div className='mt-[15px] font-[700] uppercase'>
                                                    <label className='w-[100%]'>FATHER’S NAME</label>
                                                    <input type="text" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Father_Name} onChange={(e) => formik.setFieldValue('Father_Name', e.target.value)} />
                                                </div>


                                                <div className='mt-[15px] font-[700] uppercase'>
                                                    <label className='w-[100%]'>DATE OF BIRTH</label>
                                                    <input type="date" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Date_Of_Birth} onChange={(e) => formik.setFieldValue('Date_Of_Birth', e.target.value)} />
                                                </div>
                                                ...
                                                <div className='mt-[15px] font-[700] uppercase'>
                                                    ...
                                                    <input type="text" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].Address} onChange={(e) => formik.setFieldValue('Address', e.target.value)} />
                                                </div>


                                                <div className='mt-[15px] font-[700] uppercase'>
                                                    <label className='w-[100%]'>CITY</label>
                                                    <input type="text" className=' uppercase w-[100%] p-2 border-[1px] border-[black] rounded-[10px]' defaultValue={user[0] === undefined ? "No Data Found" : user[0].City} onChange={(e) => formik.setFieldValue('City', e.target.value)} />
                                                </div>
