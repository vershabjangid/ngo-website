...
export function Home() {
    ...
    console.log(homemanagementprofiledata)
                                        ...
                                        homegoalscarddata.length === 0 ?
                                            ...
                                            <section className='w-[100%] '>
                                                <section className='w-[100%] flex justify-center '  >
                                                    <section className='home_goals_options w-[100%] overflow-x-scroll grid grid-flow-col'>
                                                        {
                                                            homegoalscarddata.map((items, index) => {
                                                                return (
                                                                    <section key={index} className={status === index ? 'border-b-[2px] border-[#1385ff] text-[#1385ff] font-[600] cursor-pointer p-[10px] px-[20px] mb-[20px]  whitespace-nowrap' : ' border-b-[2px] border-[black] p-[10px] px-[20px] mb-[20px] cursor-pointer  whitespace-nowrap font-[600]'} onClick={() => setmodel(true) || setstatus(index)}>
