                                        ...
                                        <div key={index} className='login_form_section w-[90%] mt-[15px]'>
                                            <label className='text-[15px] font-[600]'>{labelname[index]}</label>
                                            {
                                                inputtype[index] === "password" ?
                                                    ...
                                                    :
                                                    <input type={inputtype[index]} autoComplete="true" className='w-[100%] border-[1px] mt-1 border-[black] p-3 rounded-[10px] text-[14px]' placeholder={placeholder[index]} onChange={(e) => formik.setFieldValue(inputname[index], e.target.value)} />
                                            }
                                        </div>
                                    )
                                })
