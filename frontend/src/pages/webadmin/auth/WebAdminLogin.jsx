...
export function WebAdminLogin() {
    ...
    let fetchapi = (value) => {
        try {
            apiurl.post('/admin/web-admin-login', value)
                .then((res) => {
                ...
                <section className='w-[400px] border-[1px] border-[black] p-[10px] rounded-[10px]'>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div>
                            ...
                            <input type="email" className=' border-[1px] border-[black] w-[100%] p-2 rounded-[10px]' onChange={(e) => formik.setFieldValue('Email', e.target.value)} />
                        ...
                        <div className='my-[10px]'>
                            ...
                            <input type="password" className=' border-[1px] border-[black] w-[100%] p-2 rounded-[10px]' onChange={(e) => formik.setFieldValue('Password', e.target.value)} />
                            <div className='text-[red]'>
